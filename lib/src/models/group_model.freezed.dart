...
class _$GroupModelImpl extends _GroupModel {
  ...
  @override
  String toString() {
    return 'GroupModel(uid: $uid, name: $name, description: $description, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, uid, name, description, createdAt, updatedAt);
...
abstract class _GroupModel extends GroupModel {
  factory _GroupModel(
      ...
      @DateTimeOrNullConverter() final DateTime? updatedAt}) = _$GroupModelImpl;
